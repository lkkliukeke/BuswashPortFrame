...
localexcel = public.get_xls('LoginExcel.xlsx', 'attach')
...
class TestAttachPage:
    @pytest.mark.parametrize('excelist', localexcel)
    @allure.feature('test_attachpage')
    @allure.title('素材下发/素材中心模块')
    @allure.story('100%')
    def test_attach(self, excelist):
        #设置url
