...
localexcel = public.get_xls('RecordsExcel.xlsx', 'disinfect')
...
class TestDisinfectlPage:
    @pytest.mark.parametrize('excelist', localexcel)
    @allure.feature('test_disinfectpage')
    @allure.title('消杀模块/异常血压模块')
    @allure.story('100%')
    def test_disinfect(self, excelist):
        #设置url
